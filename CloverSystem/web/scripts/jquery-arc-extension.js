...
(function($) {
	...
	*/
	$.fn._uuid_default_prefix = '';

	$.fn._uuidlet = function() {
	...
	*/
	$.fn.uuid = function(p) {
		...
		if (typeof (p) == 'object' && typeof (p.prefix) == 'string') {
			$.fn._uuid_default_prefix = p.prefix;
		} else {
			p = p || $.fn._uuid_default_prefix || '';
			return (p + $.fn._uuidlet() + $.fn._uuidlet() + "-" + $.fn._uuidlet() + "-" + $.fn._uuidlet() + "-" + $.fn._uuidlet() + "-" + $.fn._uuidlet() + $.fn._uuidlet() + $.fn._uuidlet());
		};
