...
<div class="block GW1-15">
 <div class="R GW1-15">
     <div class="block general T_mainHead"> <span id="currentStoreName"><s:property value="currentStore.storeName"/></span> <span class="T_mainHead2"> &nbsp;&nbsp; 添加日销售报告<span class="T_mainHead2"> &nbsp;&nbsp;&nbsp;&nbsp;选择报告日期: <input type="text" id="reportDate" name="reportDate" class="input-normal" value="${currentDate}" style="height:24px;width:220px;" onclick="showCalendar('reportDate', 'y-mm-dd');"/></span> </span></div>
         ...
         <div class="block GW1-15" style="margin-bottom: 20px;">
                 <div class="R" style="margin-top: 10px">
                     <div class="block textB2" style="width: 900px; margin-bottom: 4px;">
                         <a href="#" onclick="ExchangeStore();">切换店铺 或 输入店铺名称</a>
            ...
            success: function(data) {
                ...
                if(compareStores != null && compareStores != "")
                {
                    ...
                    else
                    {
                        for(var i =0;i<compareStoresArray.length;i++)
                        {
                            ...
                            html += "<td style='text-align:left;width:600px;'>销售明细 : <input style='width:450px;height:30px;' type='text' id='txtAppendDetail" + i + "' class='input-normal' value='" + "" + "' /> </td>";
                            html += "</tr>";
                ...
                if(productionCategorys != null && productionCategorys != "")
                {
                    ...
                    for(var i =0;i<productionCategoysArray.length;i++)
                    {
                        ...
                        html2 += "<td style='text-align:left;width:600px;'>策略金额 : <input style='width:80px;height:30px;' type='text' onblur='return IsNumeric(this);' id='txtCategorySaleValue" + i + "' class='input-normal' value='" + "" + "' /> 元</td>";
                        html2 += "</tr>";
