    ...
    <div class="page">
                ...
                <div class="R GW1-15">
                    <div class="block general">
                        <div class="block general" style="margin-right: 10px;">
                            <%--<div class="img_logo">--%>
                            <%--</div>--%>
                            <span id="logoTitle" style="font-weight:bold;font-size:24px;color:#666666;">Morning Sale</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="Companies-Result-Content">
            ...
            <tr>
             ...
             <s:form action="login!commonLogin" namespace="/user" method="post" theme="simple">
            <tr>
                <td style="padding-left: 20px; padding-bottom: 5px; padding-top: 5px; width: 300px;"
                    class="labelNormal block text">
                    用户名 <span class="text2R"></span>
                </td>
            </tr>
            <tr>
                <td style="padding-bottom: 5px; padding-left: 20px;">
                    <s:textfield name="username" cssClass="inputBoxB" size="30" value=""/>
                    <br />
            ...
            <tr>
                <td style="padding-left: 20px; padding-bottom: 5px; padding-top: 5px; width: 300px;"
                    class="labelNormal block text">
                    密码 <span class="text2R"></span>
                </td>
            </tr>
            <tr>
                <td class="text" style="padding-bottom: 5px; padding-left: 20px;">
                    <s:password name="password" cssClass="inputBoxB" size="30" value=""/>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding: 5px 0px 10px 20px;">
                    <s:submit value=" 登 陆 " cssClass="btn submitBoxB" onmousemove="this.style.backgroundColor='#E1EDF6'" onmouseout="this.style.backgroundColor='#FFF'"/>
                </td>
            </tr>
            <tr>
                <td class="T_pdf" style="padding: 5px 0px 0px 20px;">
                    忘记密码 请 联系本公司 相关人员 重置密码
                </td>
            </tr>
            </s:form>
            <tr>
        ...
        <div class="R">
            <div class="block GW1-15 text">
                <div class="block text" style="padding-bottom: 60px; padding-top: 20px;">
                    ...
                    QQ at <a class="T_pdf">15880035</a>&nbsp;&nbsp; </div>
                </div>
            </div>
        </div>
    </div>
