        ...
        tablesorterFilter: new function() {
            ...
            function doFilter(table, phrase) {
                ...
                if (!phrase_length == 0) {
                    ...
                    //alert('test');
                    // Used to return the results of the search to the table. Matt A.
                    $(".TotalRecords").text(resultRows.length);
                    // Set the results of the search to be the end number if less than 25. Matt A.
                    if (resultRows.length < 25) {
                        $(".endR").text(resultRows.length)
                    }
                    else {
                        $(".endR").text('25');
                    }
                    ...
                    //New code to get rid of the our of memory error
            ...
            this.construct = function(settings) {
                ...
                return this.each(function() {
                    ...
                    $(config.filterSearch).click(function() {
                        var timerWait = 1;
                        var overrideBool = false;
                        var inputBox = document.getElementById("filter-box");
